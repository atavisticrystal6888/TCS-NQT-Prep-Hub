...
const INTERVIEW_DATA = {
    ...
    managerial: [
        ...
        {q: "What do you know about TCS?", a: "TCS was founded in 1968 and is headquartered in Mumbai. It is part of the Tata Group and is led by CEO & MD K. Krithivasan. TCS reported over US$30 billion in FY 2026 revenue and has 584K+ employees across 56 countries with 194 service delivery centers. Tagline: 'Building on Belief'. Mention a few relevant platforms such as BaNCS, Ignio, Quartz, or TCS iON if the role makes that useful.", difficulty: "Easy", tip: "Use current facts from TCS.com, not old package charts"},
        ...
        {q: "Why TCS over other IT companies?", a: "TCS combines global scale, brand trust, and exposure to large enterprise clients across industries. For a fresher, the biggest advantages are structured onboarding, internal learning opportunities, and the chance to work across multiple technologies and domains over time. The Tata Group reputation, broad delivery footprint, and stable long-term growth make it a strong place to start and build depth.", difficulty: "Easy", tip: "Mention structured learning, delivery scale, and domain variety"},
    ...
    hr: [
        ...
        {q: "What are your salary expectations?", a: "Compensation usually varies by hiring track, role, and current drive. 'I'm comfortable with the standard compensation band for this role and more focused on learning, meaningful project exposure, and long-term growth. I'd be happy to understand the role scope and compensation structure for this specific position.'", difficulty: "Medium", tip: "Check the current drive notice before the interview"},
        ...
        {q: "[ASK] What training programs does TCS offer to freshers?", a: "Context: Ask about the current onboarding/training format, duration, technologies covered, and evaluation model because these can change by business unit and hiring track. This shows eagerness to learn without assuming every drive follows the same structure.", difficulty: "Easy", tip: "Shows eagerness to learn"},
